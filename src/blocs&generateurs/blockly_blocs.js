...
Blockly.Blocks["controls_switch"] = {
  init: function () {
    ...
    this.setMutator(
      new Blockly.Mutator(["controls_case_break", "controls_case_default"])
    );
    var thisBlock = this;
    this.setTooltip(function () {
...
Blockly.Blocks["controls_switch_var"] = {
  init: function () {
    this.setColour(Blockly.Blocks.controls.HUE);
    this.appendDummyInput().appendField(
      Blockly.Msg.CONTROLS_SWITCH_MSG_SWITCHVAR
    );
    this.appendStatementInput("STACK");
    this.setTooltip(Blockly.Msg.CONTROLS_IF_IF_TOOLTIP);
    this.contextMenu = false;
...
Blockly.Blocks["controls_case_default"] = {
  init: function () {
    this.setColour(Blockly.Blocks.controls.HUE);
    this.appendDummyInput().appendField(
      Blockly.Msg.CONTROLS_SWITCH_MSG_DEFAULT
    );
    this.setPreviousStatement(true);
    this.setTooltip(Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP);
    this.contextMenu = false;
...
Blockly.Blocks["inout_onoff"] = {
  init: function () {
    ...
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(
      new Blockly.FieldDropdown(Blockly.Msg.FIELDDROPDOWN),
      "BOOL"
    );
...
Blockly.Blocks["logic_operation"] = {
  init: function () {
    ...
    this.appendValueInput("B").appendField(
      new Blockly.FieldDropdown(Blockly.Msg.LOGIC_OPERATOR),
      "OP"
    );
    this.setInputsInline(true);
    var thisBlock = this;
...
Blockly.Blocks["math_change"] = {
  ...
  renameVar: function (e, l) {
    Blockly.Names.equals(e, this.getFieldValue("VAR")) &&
      this.setFieldValue(l, "VAR");
  },
  customContextMenu: function (e) {
    if (!this.isCollapsed()) {
      ...
      o.setAttribute("type", "variables_get"),
        (l.callback = Blockly.ContextMenu.callbackFactory(this, o)),
        e.push(l);
    }
  },
...
Blockly.Blocks["math_map"] = {
  init: function () {
    this.jsonInit({
      ...
      tooltip: Blockly.Msg.m_pap_tooltip,
      helpUrl: Blockly.Msg.HELPURL,
    });
  },
};
...
Blockly.Blocks["list_create"] = {
  init: function () {
    this.appendValueInput("list")
      .appendField(Blockly.Msg.LISTS_CREATE1)
      .appendField(
        new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM),
        "VAR"
      )
      .appendField(Blockly.Msg.LISTS_CREATE2);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["list_set"] = {
  init: function () {
    this.jsonInit({
      message0: Blockly.Msg.LISTS_SET,
      args0: [
        {
          type: "input_value",
          name: "index",
      ...
      previousStatement: null,
      nextStatement: null,
      tooltip: Blockly.Msg.ARRAY_GETINDEX_TOOLTIP3,
      helpUrl: Blockly.Msg.HELPURL,
    });
...
Blockly.Blocks["list_get"] = {
  init: function () {
    this.appendValueInput("index").appendField(Blockly.Msg.LISTS_GET);
    this.appendDummyInput()
      .appendField(Blockly.Msg.LISTS_of)
      .appendField(
        new Blockly.FieldVariable(Blockly.Msg.VARIABLES_GET_ITEM),
...
Blockly.Blocks["creer_tableau"] = {
  ...
  getVarType: function (varName) {
    console.log(111, Blockly.Types.getChildBlockType(this));
    return Blockly.Types.getChildBlockType(this);
  },
  renameVar: function (oldName, newName) {
    if (Blockly.Names.equals(oldName, this.getFieldValue("VAR")))
...
Blockly.Blocks["array_create_with_item"] = {
  init: function () {
    this.setColour(Blockly.Blocks.tab.HUE);
    this.appendDummyInput().appendField(
      Blockly.Msg.ARRAY_CREATE_WITH_ITEM_TITLE
    );
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks["array_create_with_container"] = {
  init: function () {
    this.setColour(Blockly.Blocks.tab.HUE);
    this.appendDummyInput().appendField(
      Blockly.Msg.ARRAY_CREATE_WITH_CONTAINER_TITLE_ADD
    );
    this.appendStatementInput("STACK");
...
Blockly.Blocks["mrtduino_pin"] = {
  ...
  init: function () {
    ...
    this.setOutput(true, "Number");
    this.setTooltip(
      "MRTduino pins conversion. You select port and this block convert into arduino pin"
    );
  },
};
...
Blockly.Blocks["conversion_tobyte"] = {
  init: function () {
    this.setColour(Blockly.Blocks.math.HUE);
    this.appendValueInput("NAME").appendField(Blockly.Msg.CONV_tobyte);
    this.setOutput(true, "Number");
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
...
Blockly.Blocks["conversion_toint"] = {
  init: function () {
    this.setColour(Blockly.Blocks.math.HUE);
    this.appendValueInput("NAME").appendField(Blockly.Msg.CONV_toint);
    this.setOutput(true, "Number");
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
...
Blockly.Blocks["conversion_tounsignedint"] = {
  init: function () {
    this.setColour(Blockly.Blocks.math.HUE);
    this.appendValueInput("NAME").appendField(Blockly.Msg.CONV_tounsigendint);
    this.setOutput(true, "Number");
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
    this.setTooltip("Converts a value to the Int data type. ");
...
Blockly.Blocks["conversion_tofloat"] = {
  init: function () {
    this.setColour(Blockly.Blocks.math.HUE);
    this.appendValueInput("NAME").appendField(Blockly.Msg.CONV_tofloat);
    this.setOutput(true, "Number");
    //this.setPreviousStatement(true);
    //this.setNextStatement(true);
