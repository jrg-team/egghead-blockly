...
Blockly.Blocks["inout_analog_write_esp32"]={init:function(){
		var card=window.localStorage.card;
        this.setColour("#00929f");
        this.setHelpUrl(Blockly.Msg.HELPURL);
        this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1).appendField(new Blockly.FieldDropdown(profile[card].dropdownPWM), "broche");
...
Blockly.Blocks["inout_attachInterrupt_esp8266"]={init:function(){
		var card=window.localStorage.card;
		var prog = window.localStorage.prog;
        this.setColour("#00929f");
        this.setHelpUrl(Blockly.Msg.HELPURL);
...
Blockly.Blocks["base_code"]={init:function(){
	var prog = window.localStorage.prog;
	if (prog != "python") {
		this.appendDummyInput().appendField(new Blockly.FieldTextInput("自定义Arduino代码;"), "TEXT");
	} else {
...
Blockly.Blocks['eeprom_write']={init:function(){
    this.appendValueInput("val") .appendField(Blockly.Msg.EEPROM_write);
	this.appendValueInput("adr") .setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.EEPROM_address);
	this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#154360");
    this.setTooltip(Blockly.Msg.EEPROM_write_tips);
    this.setHelpUrl(Blockly.Msg.HELPURL);
  }
};
Blockly.Blocks["eeprom_read"]={init:function(){
        this.appendValueInput("adr").setCheck("Number").appendField(Blockly.Msg.EEPROM_read);
        this.setInputsInline(true);
        this.setColour("#154360");
        this.setHelpUrl(Blockly.Msg.HELPURL);
        this.setOutput(true, "Number");
