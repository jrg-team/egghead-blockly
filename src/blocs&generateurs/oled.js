...
Blockly.Blocks['OLED_scroll'] = {
  init: function() {
    this.appendDummyInput()  .appendField(`🖥️ ${Blockly.Msg.ST7735_Scroll}`) .appendField(new Blockly.FieldDropdown([["👈", "left"], ["👉", "right"], ["🛑", "stop"]]), "mode") ;
    this.setInputsInline(false);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour("#B655F5");
...
Blockly.Blocks['OLED_invert'] = {
  init: function() {
    this.appendDummyInput()  .appendField(`🖥️ ${Blockly.Msg.ST7735_Invert}`) .appendField(new Blockly.FieldDropdown([[Blockly.Msg.yes, "true"], [Blockly.Msg.no, "false"]]), "mode") ;
    this.setInputsInline(false);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour("#B655F5");
