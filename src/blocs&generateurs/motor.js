...
Blockly.Blocks["servo_movemicros"]={init:function(){
	...
	this.appendDummyInput().appendField(Blockly.Msg.pin).setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PIN");
	this.appendValueInput("DEGREE", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.microseconds);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#4759F5");
...
Blockly.Blocks["servo_attach"]={init:function(){
	var card=window.localStorage.card;
    this.appendDummyInput().appendField(new Blockly.FieldImage('media/servo.png', 22, 22, "*")).appendField(Blockly.Msg.ARDUINO_SERVO_ATTACH);
    //this.appendValueInput("PIN", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.pin);
	this.appendDummyInput().appendField(Blockly.Msg.pin).setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PIN");
    this.setInputsInline(true);
...
Blockly.Blocks["servo_detach"]={init:function(){
	var card=window.localStorage.card;
    this.appendDummyInput().appendField(new Blockly.FieldImage('media/servo.png', 22, 22, "*")).appendField(Blockly.Msg.ARDUINO_SERVO_DETACH);
    //this.appendValueInput("PIN", "Number").setCheck("Number").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.pin);
	this.appendDummyInput().appendField(Blockly.Msg.pin).setAlign(Blockly.ALIGN_RIGHT)
        .appendField(new Blockly.FieldDropdown(profile[card].dropdownAllPins), "PIN");
    this.setInputsInline(true);
...
Blockly.Arduino["servo_read_degrees"]=function(block){
  ...
  Blockly.Blocks["servo_attached"]= {
    init: function() {
	  var card=window.localStorage.card;
      this.appendDummyInput() .appendField(new Blockly.FieldImage('media/servo.png', 22, 22, "*")) .appendField(Blockly.Msg.ARDUINO_SERVO_IS_ATTACHED) ;
...
Blockly.Blocks['motor_run'] = {
  init: function() {
	...
	.appendField(new Blockly.FieldDropdown(Blockly.Msg.mot_directions2), "MOTOR_DIR");
...
Blockly.Blocks['motor_MRT_Node_run'] = {
  init: function() {
    ...
    this.appendDummyInput()
    .appendField(Blockly.Msg.MOTOR_Direction)
	.appendField(new Blockly.FieldDropdown(Blockly.Msg.mot_directions), "MOTOR_DIR");
	 this.appendValueInput("CONTENT", 'Number')
        .setCheck('Number')
    .appendField(Blockly.Msg.MOTOR_speed)
    this.setInputsInline(true);
