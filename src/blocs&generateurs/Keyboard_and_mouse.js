...
Blockly.Blocks['keyboard_function'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(Blockly.Msg.KeyboardAction), "KEY_FUN");
...
Blockly.Blocks['mouse_function'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(Blockly.Msg.MouseAction), "MOUSE_BUTTON");
   	this.appendDummyInput()
		.appendField(new Blockly.FieldDropdown(Blockly.Msg.MouseKey), "MOUSE_BUTTON2");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("These core libraries allow the 32u4 and SAMD based boards (Leonardo, Esplora, Zero, Due and MKR Family) to appear as a native Mouse and/or Keyboard to a connected computer.");
...
Blockly.Blocks['keyboard_function_esp32'] = {
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("These core libraries allow the esp32 using BLE to appear as a native Keyboard to a connected computer.");
  }
};
...
Blockly.Blocks['mouse_function_esp32'] = {
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("These core libraries allow the esp32 using BLE to appear as a native Mouse  to a connected computer.");
  }
};
