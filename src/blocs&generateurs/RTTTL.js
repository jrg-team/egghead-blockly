...
Blockly.Blocks["RTTTL_music"] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown(profile[card].dropdownAllPins),
        "PIN_BUZZER"
      );
    this.appendDummyInput()
...
Blockly.Arduino["RTTTL_music_custom"] = function (block) {
  var PIN_BUZZER = block.getFieldValue("PIN_BUZZER");
  var rtttl_melody = Blockly.Arduino.valueToCode(
    block,
    "rtttl_melody",
  ...
  var code;
  Blockly.Arduino.includes_["include_PlayRTTTL"] = "#include <PlayRtttl.hpp>\n";
  Blockly.Arduino.definitions_["Melody_" + name_melody] =
    "static const char melody_" +
    name_melody +
    "[] PROGMEM = " +
    rtttl_melody +
    ";\n";
...
// This is a particular configutration for MRTX-Uno Board

Blockly.Blocks["RTTTL_music_x"] = {
  init: function () {
    this.setColour("#FF63BB");
...
Blockly.Arduino["RTTTL_music_x"] = function (block) {
  var melody = this.getFieldValue("MELODY");
...
Blockly.Blocks["RTTTL_music_custom_x"] = {
  init: function () {
    this.setColour("#FF63BB");
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_TONE_INPUT1_X);
    this.appendValueInput("rtttl_melody")
...
Blockly.Arduino["RTTTL_music_custom_x"] = function (block) {
  var rtttl_melody = Blockly.Arduino.valueToCode(
    block,
    "rtttl_melody",
    Blockly.Arduino.ORDER_ATOMIC
