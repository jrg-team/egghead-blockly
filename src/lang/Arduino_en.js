...
Blockly.Msg.CAT_MATH = "🔢 Operators";
...
Blockly.Msg.CAT_OTTO_ARMS = "🦾 Arms";
...
Blockly.Msg.CAT_ultrason = "👓 Ultrasonic";
Blockly.Msg.CAT_SENSORS = "👂 Sensing";
Blockly.Msg.CAT_BUTTONS = "👇 Buttons";
Blockly.Msg.CAT_LINE = "➰ Line following";
...
Blockly.Msg.CAT_BME280 = "🗜️ Pressure";
...
Blockly.Msg.CAT_com = "📡 Communicate";
Blockly.Msg.CAT_ARDUINO_COMM_SERIAL = "ℹ️ USB Serial";
Blockly.Msg.CAT_ARDUINO_COMM_SOFTSERIAL = "ℹ️ Software Serial";
Blockly.Msg.CAT_bluetooth = "🔵 Bluetooth";
Blockly.Msg.CAT_RemoteIR = "🕹️ Remote Control";
...
Blockly.Msg.menublink = [["normal", "1000"],["slow", "2000"],["very slow", "5000"] , ["fast", "500"], ["very fast", "200"]];
...
Blockly.Msg.FIELDDROPDOWN = [["1 HIGH", Blockly.Msg.high], ["0 LOW", Blockly.Msg.low]];
...
Blockly.Msg.bme280="atmospheric pressure I²C";
...
Blockly.Msg.SOUND_NAME="microphone";
...
Blockly.Msg.DHT_Temp="🌡️ temperature ºC";
Blockly.Msg.DHT_Humi="💧 humidity %";
Blockly.Msg.DHT_Head="☀️ heat Index ºC";
...
//Encoder
Blockly.Msg.RotaryEncoderInit="rotary encoder";
Blockly.Msg.RotaryEncoderNumber="encoder";
Blockly.Msg.RE_withoutInterrupt="without interrupts";
Blockly.Msg.RE_PINDT="DT";
Blockly.Msg.RE_PINCLK="CLK";
...
// SOFTWARE SERIAL
Blockly.Msg.SSERIAL_Init="software serial";
Blockly.Msg.SSERIAL_TX="TX";
Blockly.Msg.SSERIAL_RX="RX";
Blockly.Msg.SSERIAL_BAUD="bauds";
Blockly.Msg.SSERIAL_Read="software serial read byte";
Blockly.Msg.SSERIAL_Println="software serial print on new line";
Blockly.Msg.SSERIAL_Print="software serial print on same line";
Blockly.Msg.SSERIAL_Write="software serial write"
Blockly.Msg.SSERIAL_Avai="software serial available?";
Blockly.Msg.SSerial_Print_Format="software serial print format";
Blockly.Msg.SSERIAL_ReadNum="software serial read as number";
Blockly.Msg.SSERIAL_ReadString="software serial read string";
Blockly.Msg.SSERIAL_Readlf="until line feed";

// SERIAL
Blockly.Msg.SERIAL_Init="USB serial";
...
Blockly.Msg.toggle = "toggle state of PIN";
...
Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_TOOLTIP = "Send a PWM value between 0 and 255 on a specific output";
...
Blockly.Msg.OTTO9_SOUND_CHOICE = [ ["😃 happy1", "S_superHappy"], ["🙂 happy2", "S_happy"], ["😊 happy3", "S_happy_short"], ["🙁 sad", "S_sad"], ["😕 confused", "S_confused"], ["🤗 cuddly", "S_cuddly"], ["🦘 jump", "S_JUMP"],["☠️ pirate", "PIRATES"], ["😮 Oh", "S_OhOoh"], ["😯 OhOoh", "S_OhOoh2"], ["😲 surprise", "S_surprise"],["🤖 connect", "S_connection"], [" 🤖 disconnect", "S_disconnection"], ["👇 push", "S_buttonPushed"], ["❗ 1", "S_mode1"], ["❗❗ 2", "S_mode2"], ["❗❗❗ 3", "S_mode3"], ["💤 sleep", "S_sleeping"], ["💩 fart1", "S_fart1"], ["💩 fart2", "S_fart2"], ["💩 fart3", "S_fart3"],];
Blockly.Msg.OTTO9_GETDISTANCE_TEXT = "distance [cm]";
Blockly.Msg.OTTO9_GETDISTANCE_TOOLTIP = "Pin Trigger 8 Pin Echo 9. Ranging distance between 2cm to 400cm";
...
Blockly.Msg.OTTO9_GETNOISE_TOOLTIP = "Pin A6, 100 is quiet, 500 noise and more than 1000 is loud, also adjust the sensor trimpot sensibility";
...
Blockly.Msg.OTTO9_MATRIX_TOOLTIP = "Pins: DIN A3, CS A2, CLK A1, Limited to CAPITALS A to Z NUMBERS 0 to 9 : ; < >  = @, max.9 characters";
...
// LED
Blockly.Msg.ARDUINO_INOUT_BUILDIN_LED_INPUT = "💡 LED board";
...
Blockly.Msg.ARDUINO_NOTONE_INPUT = "🛑 stop sound on";
Blockly.Msg.ARDUINO_NOTONE_TOOLTIP = "stop the sound on the selected Pin";
Blockly.Msg.ARDUINO_RTTTL_BLOCK = "play ring tone";
...
Blockly.Msg.lp2i_mp3_play = "▶️ play MP3";
Blockly.Msg.lp2i_mp3_play_track_tooltip = "▶️ plays the specified track song file 0-2999";
Blockly.Msg.lp2i_mp3_play_tooltip = "▶️ plays the current song file";
Blockly.Msg.lp2i_mp3_pause = "⏸️ pause MP3";
Blockly.Msg.lp2i_mp3_pause_tooltip = "pause the current song file";
Blockly.Msg.lp2i_mp3_prev = "⏮️ play previous MP3";
Blockly.Msg.lp2i_mp3_prev_tooltip = "⏮️ reads the previous track song file";
Blockly.Msg.lp2i_mp3_vol = "🎚️ set the volume";
Blockly.Msg.lp2i_mp3_vol_tooltip = "🎚️ sets the volume to the specified value [0-31]";
Blockly.Msg.lp2i_mp3_next = "⏭️ play next MP3 ";
...
Blockly.Msg.ARDUINO_SERVO_ATTACH = "attach"
Blockly.Msg.ARDUINO_SERVO_DETACH = "detach"
Blockly.Msg.ARDUINO_SERVO_IS_ATTACHED = "attached?"
//engine
...
Blockly.Msg.mot_directions = [['Forward', '0'],['Backward', '1']]
Blockly.Msg.mot_directions2 = [['Forward', 'HIGH'],['Backward', 'LOW']]
...
Blockly.Msg.ESCORNABOT_APP_URL="https://escornabot.com/es/descargas";
Blockly.Msg.ESCORNABOT_USINIT_TEXT="Ultrasonic";
Blockly.Msg.ESCORNABOT_TRIGGER_TEXT="Trigger";
Blockly.Msg.ESCORNABOT_ECHO_TEXT="Echo";
...
//LCD I2C
Blockly.Msg.LCD_I2C_setup = "LCD I²C address";
...
Blockly.Msg.LCDP_showCursor = "LCD I²C show cursor ";
Blockly.Msg.LCDP_blinkCursor = "LCD I²C blink cursor ";
Blockly.Msg.LCDP_Home = "LCD I²C home";
Blockly.Msg.LCDP_SetCursor = "LCD I²C set cursor";
Blockly.Msg.LCDP_Display = "LCD I²C ";

//LCD screen
Blockly.Msg.lcd_fond = "bottom";
Blockly.Msg.LCD = "LCD screen";
Blockly.Msg.LCDi2c_tooltip = "initializes the 2-line, 16-character I²C LCD with RGB backlight. \n Displayer <-> Arduino \nSDA <--------> A4 \nSCL <- -------> A5 ";
...
Blockly.Msg.APDS9960_init = "gesture & color";
...
//REMOTE CONTROL MRT
Blockly.Msg.MRT_IR="remote Control MRT";
...
Blockly.Msg.ST7735_FILLBACKGROUND = "fill background color";
Blockly.Msg.ST7735_Rotate = "rotate";
Blockly.Msg.ST7735_Invert = "invert";
Blockly.Msg.ST7735_Scroll = "scroll";
...
//OLED
Blockly.Msg.OLED_IconName = "icon design";
...
Blockly.Msg.TCS34725_name_init="color";
...
Blockly.Msg.TCS34725_color2="no gain?";

//HMC5883 compass sensor
Blockly.Msg.HMC5883="compass";
...
Blockly.Msg.MouseMoveX="X position";
Blockly.Msg.MouseMoveY="Y position";
Blockly.Msg.MouseMoveW="wheel";
Blockly.Msg.MouseAction = [['Click','1'],['Press','2'],['Release','3']]
Blockly.Msg.MouseKey = [['Left','1'],['Right','2'],['Center','3']]
Blockly.Msg.KeyboardAction = [['Press key','1'],['Release','2'],['Only press','3']]

//GPS
Blockly.Msg.GPS_name = "🛰️ GPS NEO-6";
Blockly.Msg.GPS_init = "GPS";
...
Blockly.Msg.GPS_paramter3 = "date time:";

//TM1640
Blockly.Msg.TM1640_init = "TM1640 matrix";
...
Blockly.Msg.TM1637_init = "TM1637 display 7 segment";
Blockly.Msg.TM1637_PinCLK = "CLK";
Blockly.Msg.TM1637_PinDIO = "DIO";
...
Blockly.Msg.M1637_Length = "number of digits";
...
Blockly.Msg.STEEPER_pin2="B";
Blockly.Msg.STEEPER_pin3="C";
Blockly.Msg.STEEPER_pin4="D";
...
//RTC DS3231
Blockly.Msg.RTCDS3231_NAME="RTC I²C";
...
Blockly.Msg.MAX7219_LM_NAME="LED Matrix";
Blockly.Msg.MAX7219_LM_CS="CS";
Blockly.Msg.MAX7219_LM_CLK="CLK";
Blockly.Msg.MAX7219_LM_DAT="DIN";
Blockly.Msg.MAX7219_LM_Number="#";
Blockly.Msg.MAX7219_LM_NAME2="MAX7219 Led matrix#";
Blockly.Msg.MAX7219_LM_Brightness="brightness";
Blockly.Msg.MAX7219_LM_SHUTDOWN="activate";
Blockly.Msg.MAX7219_LM_CLEAR="clear";
Blockly.Msg.MAX7219_LM_PAINT="draw";
...
// EEPROM
Blockly.Msg.EEPROM_read = "Read variable address"
Blockly.Msg.EEPROM_read_tips = "returns the data stored at the specified address (8 bits or one byte)\nATmega328p & ATmega32u4 --> 1024 bytes\nATmega2560 --> 4096 bytes"
Blockly.Msg.EEPROM_write = "Write Variable"
Blockly.Msg.EEPROM_write_tips = "allows writing data (8 bits or one byte) in EEPROM memory, at the specified address\nATmega328p & ATmega32u4 --> 1024 bytes\nATmega2560 --> 4096 bytes"
